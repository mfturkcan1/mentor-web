...
export default function RoutineListComponent() {
	...
	return (
		<div className="flex items-center justify-center" style={{ width: 1400 }}>
			<AppDialog
			...
			/>
			<Card className="shadow-sm p-6" style={{ width: 1400 }}>
