...
import type { GoalResponse } from "@/models/Goal"; // path sende farklıysa düzelt
...
export function GoalsTable() {
	...
	const cols =
		"grid-cols-[minmax(220px,1.4fr)_minmax(260px,2fr)_minmax(110px,0.8fr)_minmax(150px,1fr)_minmax(150px,1fr)_minmax(160px,1fr)_minmax(120px,0.9fr)_minmax(120px,0.9fr)_minmax(120px,0.9fr)_minmax(120px,0.9fr)_minmax(90px,0.7fr)_minmax(120px,0.9fr)_minmax(170px,1fr)_minmax(170px,1fr)_minmax(150px,0.9fr)]";
								...
								<div className="overflow-x-auto">
									...
									<div className="divide-y min-w-[1700px]">
										{filtered.slice(0, 10).map((g) => (
											<div
												key={g.id}
												className={`grid ${cols} gap-2 px-3 py-3 items-center`}
											>
												...
												<div className="text-sm">{g.parent_goal_id ?? "-"}</div>
